...
<img src="img/logo.png"  alt="" width="50" height="44" class="d-inline-block align-text-top" style="float: left;" ><b><?php echo $_GET['uname'];?> Cart</b></p>    
<div>
		...
		<div class="container" style="box-shadow: 10px 5px 10px 7px #f28741;">
			...
			?>
								...
								<!-- <td width="1%"><input type="number" value="1" min="1" max="20" class="form-control" id="exampleInputEmail1"  style="width: 60%;"></td> -->
									<td width="1%" style="margin-left: 4%;" ><span class="price" id="price"><?php echo $cart_details['prod_price']; ?></span> &#8377</td>
									<?php
										if($cart_details['boolean']==0){
									?>
					        		<td width="1%"><span class="in-stock-box btn btn-warning" style="background-color: #f28741; color:white;">Out Of Stock</span></td>
									<?php
										}else{
									?>
									<td width="1%"><span class="in-stock-box btn btn-success" style="background-color: green; color:white;">In Stock</span></td>
									<?php
										}
									?>
					        		<td width="1%"><a class="round-black-btn btn-outline-warning" style="border-color: #f28741; font-weight: 30px;" href="placeorder.php?email=<?php echo $cart_details['email']; ?>&uname=<?php echo $cart_details['username']; ?>">BUY NOW</a></td>
					        		<td width="1%" class="text-center"><a href="#" class="btn btn-danger">X</a></td>
					        	</tr>
