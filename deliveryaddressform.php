...
<div class="cart-wrap" >
  ...
  <input type="text" name="locality" class="form-control" id="exampleFormControlInput1" placeholder="" required>
</div>
...
<div class="mb-3">
  ...
  <input type="text" name="landmark" class="form-control" id="exampleFormControlInput1" placeholder="" required>
</div>
<button style="margin-left: 45%;" type="submit" name="adddeliveryaddress" class="btn btn-primary">Add</button>
                    </form>
			    </div>
			</div>
		</div>
